...
BEGIN Animation
    ...
    CurrentTime        3 Dec 2013 03:38:10.000000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN MapAttributes
            PrimaryBody          Earth
            SecondaryBody        Sun
            CenterLatitude       9.000000
            CenterLongitude      3.954734
...
BEGIN References
    ...
    END Instance
    Instance Aircraft/B747ATL_Heathrow/Transmitter/adsb_out
        Aircraft/B747ATL_Heathrow/Transmitter/adsb_out
    END Instance
    Instance Aircraft/B747JFK_Heathrow
        Aircraft/B747JFK_Heathrow
    END Instance
    Instance Aircraft/B747JFK_Heathrow/Transmitter/adsb_out
        Aircraft/B747JFK_Heathrow/Transmitter/adsb_out
    END Instance
    Instance Aircraft/B747LAX_Dubai
        Aircraft/B747LAX_Dubai
    END Instance
    Instance Aircraft/B747LAX_Dubai/Transmitter/adsb_out2
        Aircraft/B747LAX_Dubai/Transmitter/adsb_out2
    END Instance
    Instance Aircraft/B747LAX_Heathrow
        Aircraft/B747LAX_Heathrow
    END Instance
    Instance Aircraft/B747LAX_Heathrow/Transmitter/adsb_out
        Aircraft/B747LAX_Heathrow/Transmitter/adsb_out
    END Instance
    Instance Aircraft/B747SLO_Heathrow1
        Aircraft/B747SLO_Heathrow1
    END Instance
    Instance Aircraft/B747SLO_Heathrow1/Transmitter/adsb_out1
        Aircraft/B747SLO_Heathrow1/Transmitter/adsb_out1
    END Instance
    Instance Aircraft/B747seattle_dubai
        Aircraft/B747seattle_dubai
    END Instance
    Instance Aircraft/B747seattle_dubai/Transmitter/adsb_out
        Aircraft/B747seattle_dubai/Transmitter/adsb_out
    END Instance
    ...
    END Instance
    Instance Facility/Syd
        Facility/Syd
    END Instance
    Instance Facility/Syd/Receiver/ADSB_GndRcvr1
        Facility/Syd/Receiver/ADSB_GndRcvr1
    END Instance
    Instance Satellite/700kmCircle
        Satellite/700kmCircle
    END Instance
    Instance Satellite/700kmCircle/Receiver/adsb_satrcvr2
        Satellite/700kmCircle/Receiver/adsb_satrcvr2
    END Instance
    Instance Satellite/700kmCircle/Transmitter/GndLink1
        Satellite/700kmCircle/Transmitter/GndLink1
    END Instance
    Instance Satellite/Molniya1
        Satellite/Molniya1
        Satellite/Molniya1/Sensor/Sensor1
    END Instance
    Instance Satellite/Molniya1/Receiver/adsb_satrcvr
        Satellite/Molniya1/Receiver/adsb_satrcvr
    END Instance
